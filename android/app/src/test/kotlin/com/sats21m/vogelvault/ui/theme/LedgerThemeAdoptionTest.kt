...
class LedgerThemeAdoptionTest {
    ...
    private fun assertLedgerMaterialColors(
        ...
        assertEquals(palette.bitcoin, materialColors.primary)
        ...
        assertEquals(if (palette == LedgerPalettes.DaylightLight) LedgerPalettes.TerminalDark.foreground else LedgerPalettes.TerminalDark.background, materialColors.onPrimary)
