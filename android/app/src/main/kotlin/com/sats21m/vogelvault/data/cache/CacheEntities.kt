...
data class CachedBtcBuyEntity(
    ...
    @ColumnInfo(name = "fee_usd_cents") val feeUsdCents: Long,
    val note: String?,
    val status: String?,
...
data class CachedBtcAccountEntity(
    ...
    @ColumnInfo(name = "fiat_available")
    val fiatAvailable: Boolean = !(sats > 0L && fiatCents == 0L),
    @ColumnInfo(name = "fiat_price_cents") val fiatPriceCents: Long? = null,
    @ColumnInfo(name = "fiat_quoted_at") val fiatQuotedAt: String? = null,
    @ColumnInfo(name = "fiat_source") val fiatSource: String? = null,
    @ColumnInfo(name = "fiat_confidence") val fiatConfidence: String? = null,
...
data class BtcAccountCacheRow(
    ...
    val fiatCents: Long,
    val fiatAvailable: Boolean = !(sats > 0L && fiatCents == 0L),
    val fiatPriceCents: Long? = null,
    val fiatQuotedAt: String? = null,
    val fiatSource: String? = null,
    val fiatConfidence: String? = null,
    val asOf: String,
...
internal fun BtcAccountCacheRow.inSnapshot(
    ...
    sats = sats,
    fiatCents = fiatCents,
    fiatAvailable = fiatAvailable,
    fiatPriceCents = fiatPriceCents,
    fiatQuotedAt = fiatQuotedAt,
    fiatSource = fiatSource,
    fiatConfidence = fiatConfidence,
    asOf = asOf,
