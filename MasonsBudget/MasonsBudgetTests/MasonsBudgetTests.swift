...
final class MasonsBudgetTests: XCTestCase {
    ...
    func testAppThemeColorsExist() {
        ...
        XCTAssertEqual(ColorTokens.dark.surface, Color(hex: 0x0E0E0E))
    ...
    func testAppTabCases() {
        ...
        XCTAssertEqual(tabs, [.home, .activity, .budget, .tasks])
        for tab in tabs {
        ...
        XCTAssertEqual(MacNav.taskItems, [.today, .inbox, .upcoming, .flagged, .tasks])
